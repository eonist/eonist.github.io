All processes are on a concurrent background thread at this point<!--more-->. It takes only around 5 seconds to AutoSync™ 100++ Repos now. Like checking your email, but for git repos.
