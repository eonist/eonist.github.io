Notes made while researching various ways to do darkmode in iOS<!--more-->, in the end I built a small framework to help with configuring and using darkmode: [https://github.com/passbook/DarkMode](https://github.com/passbook/DarkMode) 
