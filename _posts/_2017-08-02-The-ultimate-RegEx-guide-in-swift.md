...
/**
 * 
 * forward look can have dynamic lengths
 */
public class RegExpHelp {
	public static const nonLiteralPatternExample:RegExp = new RegExp("[a-z]{4,8}", "ig");
	public static const literalPatternExample:RegExp = /[a-z]{4,8}/ig;
	public static const extendedPatternExample:RegExp = / 	(\w|[_.\-])+ 	@	 ((\w|-)+\.)+ 	\w{2,4}+	 /x;//the x-flag enables spacing or tabbing in a pattern , for more readability
	/**
	 * Flags:
	 * Enables you to define conditions for the preseding pattern
	 * 
	 ...
	 * 
	 * Meta characters (Characters Repetitionme): 
	 ...
	 * \$ \( \) \* \+ \. \? \[ \\ \^ \{ \|\-
	 *
	 * backreferencing test: "6.6".test("\d(\.?)((?1)\d)")//6.6 The important part about this example is that group 1 can be true or false. if a group can only be true this example wont work
	 */
}