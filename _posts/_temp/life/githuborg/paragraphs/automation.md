...
Author | Project | LOC | Grade | [GPA](https://hub.codebeat.co/docs/gpa-explained) | [GPA](https://hub.codebeat.co/docs/gpa-explained)
--- | --- | --- | --- | --- | ---
*Still* | `renders` | **nicely** | `renders` | **nicely** | **nicely**
1 | 2 | 3 | 2 | 3 | 3
