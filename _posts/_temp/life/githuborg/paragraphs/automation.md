...
[Ramotion](https://github.com/Ramotion)  | [animated-tab-bar](https://github.com/Ramotion/animated-tab-bar)  | 719 | `C` | 2.75 | **9125** | NA
...
**Grade**: Corresponds to GPA. Everything over 3.3 Gets an `A` ✌️   
