...
## Use a cartfile in a project: 
0. cd ~/Path/To/Starter/Project
1. touch Cartfile
1. open -a Xcode Cartfile
2. add this to the cartfile: `github "Alamofire/Alamofire" ~> 4.5.0` 
3. Sometimes you have to point xcode xorrecctly: `sudo xcode-select -s <path to Xcode 9 beta>/Xcode-beta.app/Contents/Developer `
